...
<div class="more-info">
  <div class="b-info">
    ...
    <span class="b-number">BPS Nº: <strong><?php echo $b_item["number"]; ?></strong></span>
  ...
  <form action="www/inc/edit_business.php" method="post" class="edit-business-form" enctype="multipart/form-data">
    ...
    <div>
      ...
      <div class="basic-info">
        ...
        <input class="b-rut" type="text" value="<?php echo $b_item["rut"]; ?>" id="rut" name="rut" placeholder="Business RUT..">
      </div>
    </div>

    <div class="info">
      <label class="b-number" for="number"><span>BPS Nº: </span><input type="text" value="<?php echo $b_item["number"]; ?>" id="number" name="number" placeholder="Business BPS Nº.."></label>
